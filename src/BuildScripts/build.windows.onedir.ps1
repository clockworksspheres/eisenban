...
cp BuildScripts/build.windows11.onedir.spec eisenban
...
pyinstaller --clean -y build.windows11.onedir.spec
pyinstaller -y build.windows11.onedir.spec

rm build.windows11.onedir.spec
