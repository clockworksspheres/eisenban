...
class WelcomeScreen(QMainWindow):
    ...
    def setup_font(parent: Ui_WelcomeWindow) -> None:
        ...
        parent.ui.label_login.setFont(QFont(arimo, 13, QFont.Bold))
        parent.ui.label_signup.setFont(QFont(arimo, 13, QFont.Bold))
        ...
        parent.ui.btn_login.setFont(QFont(arimo, 12, QFont.Bold))
        parent.ui.btn_signup.setFont(QFont(arimo, 12, QFont.Bold))
