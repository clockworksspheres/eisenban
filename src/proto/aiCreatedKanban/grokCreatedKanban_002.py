...
class KanbanBoard(QMainWindow):
    def __init__(self):
        ...
        # Columns stored as ordered dict (title -> column widget)
        self.columns = {}  # title -> KanbanColumn
        ...
        # If no columns exist on first run, create defaults
    ...
    def add_task(self, column_title, input_widget):
        ...
        item = QListWidget.QListWidgetItem(column)
        card = CardItem(text)
